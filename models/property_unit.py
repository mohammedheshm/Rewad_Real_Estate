...
class PropertyUnit(models.Model):
    ...
    received_commission = fields.Float(string="Received")
    remaining_commission = fields.Float(
        string="Remaining",
    ...
    @api.depends("commission", "received_commission")
    def _compute_remaining(self):
        for rec in self:
            rec.remaining_commission = rec.commission - rec.received_commission
